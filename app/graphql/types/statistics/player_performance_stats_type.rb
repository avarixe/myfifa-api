...
module Types
  module Statistics
    class PlayerPerformanceStatsType < BaseObject
      ...
      field :num_matches,
            Integer,
            "Number of Matches capped #{stats_field_suffix}",
            null: false
      field :num_minutes,
            Integer,
            "Number of Minutes played #{stats_field_suffix}",
            null: false
      field :num_goals,
            Integer,
            "Number of Goals scored #{stats_field_suffix}",
            null: false
      field :num_assists,
            Integer,
            "Number of Goals assisted #{stats_field_suffix}",
            null: false
      field :num_clean_sheets,
            Integer,
